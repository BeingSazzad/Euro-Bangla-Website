...
import phone from "@/assets/img/cta/phone.png"
                     ...
                     <div className="row align-items-end">
                        ...
                        <div className="col-lg-5 col-md-6">
                           <div className="tg-cta-content">
                              <h5 className="tg-section-subtitle text-white mb-10">{t("home.appSubtitle")}</h5>
                              <h2 className="mb-15 tg-cta-title text-white text-capitalize">{t("home.appTitle")}</h2>
                           </div>
                        </div>
